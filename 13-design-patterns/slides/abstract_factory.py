...
class ConcreteProductB1(
    AbstractProductB
):  # конкретное средство передвижения: автомобиль
    ...
    def another_useful_function_b(
        self, collaborator: AbstractProductA
    ) -> str:  # установить колесо(абстрактное колесо)
...
class ConcreteProductB2(
    AbstractProductB
):  # конкретное средство передвижения: велосипед
    def useful_function_b(self) -> str:  # ехать
        # проверить колеса: если надо, установить и надуть колеса
        # снять замок
        # крутить педали
    ...
    def another_useful_function_b(
        self, collaborator: AbstractProductA
    ):  # установить колесо(абстрактное колесо)
        """
